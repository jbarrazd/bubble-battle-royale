...
import { OptimizedSoundSystem } from '@/systems/audio/OptimizedSoundSystem';
...
export class GameScene extends Scene {
    ...
    private soundSystem!: OptimizedSoundSystem;
    ...
    private createSoundSystem(): void {
        try {
            this.soundSystem = new OptimizedSoundSystem(this);
